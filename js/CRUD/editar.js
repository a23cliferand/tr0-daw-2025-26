  ...
  editarContainer.innerHTML = `
        ...
        <form class="crud" id="editarForm">
            ...
            <div class="respostes-container">
                ...
                <input type="text" id="resposta1" name="resposta1" value="${
                  data.respostes && data.respostes[0].etiqueta
                    ? data.respostes[0].etiqueta
                    : ""
                }" required>

                <label for="resposta2">Resposta 2:</label>
                <input type="text" id="resposta2" name="resposta2" value="${
                  data.respostes && data.respostes[1].etiqueta
                    ? data.respostes[1].etiqueta
                    : ""
                }" required>

                <label for="resposta3">Resposta 3:</label>
                <input type="text" id="resposta3" name="resposta3" value="${
                  data.respostes && data.respostes[2].etiqueta
                    ? data.respostes[2].etiqueta
                    : ""
                }" required>

                <label for="resposta4">Resposta 4:</label>
                <input type="text" id="resposta4" name="resposta4" value="${
                  data.respostes && data.respostes[3].etiqueta
                    ? data.respostes[3].etiqueta
                    : ""
                }" required>
            </div>
            ...
            <select id="resposta_correcta" name="resposta_correcta" required>
                <option value="1" ${
                  data.resposta_correcta == 1 ? "selected" : ""
                }>1</option>
                <option value="2" ${
                  data.resposta_correcta == 2 ? "selected" : ""
                }>2</option>
                <option value="3" ${
                  data.resposta_correcta == 3 ? "selected" : ""
                }>3</option>
                <option value="4" ${
                  data.resposta_correcta == 4 ? "selected" : ""
                }>4</option>
            </select>
